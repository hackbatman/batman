...
print(chr(27)+"[1;33m"+"MATRIZ DE ADYACENCIA")
print(matriz_ad)
...
print(chr(27)+"[1;33m"+"Matriz de Costos/Distancias")
...
print(chr(27)+"[1;33m"+"Matriz Caminos Minimo")
print(" ")
a=""
...
print(chr(27)+"[1;33m"+"Costos/Distancias ")
print(" ")
a=""
...
resultado_texto = Entry(vp,justify="center", width=10, textvariable=r,state="disabled")
